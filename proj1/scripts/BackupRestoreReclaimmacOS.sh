...
osascript -e 'tell application "Terminal"' -e 'do script "cd '"$(pwd) && java Peer.Peer 1.0 0 clientPeer0 224.0.0.1 3456 224.0.0.2 3457 224.0.0.3 3458"\" -e 'end tell'
...
osascript -e 'tell application "Terminal"' -e 'do script "cd '"$(pwd) && java Peer.Peer 1.0 3 clientPeer3 224.0.0.1 3456 224.0.0.2 3457 224.0.0.3 3458"\" -e 'end tell'

sleep .5

java App.TestApp clientPeer1 RECLAIM 0